...
public class AppliedListActivity extends AppCompatActivity {
    ...
    public static class VolunteerViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setAge(String age){
            TextView VolunteerIdView =(TextView) mView.findViewById(R.id.ageTextVol);
            VolunteerIdView.setText(age);

        }

        public void setGender(String gender){
            TextView VolunteerIdView =(TextView) mView.findViewById(R.id.genderTextVol);
            VolunteerIdView.setText(gender);

        }

        public void setContact(String contact){
            TextView VolunteerIdView =(TextView) mView.findViewById(R.id.ContactTextVol);
            VolunteerIdView.setText(contact);
